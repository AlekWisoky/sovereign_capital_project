...
def test_risk_budget_preferences_cannot_bypass_hard_gates():
...
def test_adaptive_sizer_prefers_largest_net_profitable_size_within_budget():
...
def test_learning_reward_uses_truth_verified_settled_net_profit():
