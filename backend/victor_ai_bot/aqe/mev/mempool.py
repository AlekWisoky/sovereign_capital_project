...
_SAFE_WS_LOOP_EXCEPTIONS = (asyncio.TimeoutError, OSError, RuntimeError, TypeError, ValueError)
_SAFE_PAYLOAD_EXCEPTIONS = (AttributeError, KeyError, TypeError, ValueError)
