        ...
        try:
            ...
            omar.observe_outcome(
                ...
                realized_net_usd=float(
                    outcome.get(
                        "realized_net_usd",
                        outcome.get("realizedNetUsd", 0.0),
                    )
                    or 0.0
                ),
                expected_net_usd=float(
                    outcome.get(
                        "expected_net_usd",
                        outcome.get("expectedNetUsd", 0.0),
                    )
                    or 0.0
                ),
                amount_in_wei=int(
                ...
                outcome_truth_verified=bool(
                    outcome.get(
                        "truth_verified",
                        outcome.get("outcome_truth_verified", True),
                    )
                ),
                metadata={
                    "canonical_lineage": {
