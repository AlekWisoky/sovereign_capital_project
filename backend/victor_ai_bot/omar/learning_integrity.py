...
def _pending_sizing_id(pending: Mapping[str, Any]) -> str:
    ...
    admission = _dict(p.get("capital_admission")); details = _dict(admission.get("details"))
    institutional = _dict(details.get("institutionalSizing")); sizing = _dict(institutional.get("sizing"))
