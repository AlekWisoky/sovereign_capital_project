...
class CanonicalCapitalWriteService(CapitalWriteService):
    ...
    def commit_receipt_settlement(self, runtime: Any, *, tx_payload: Mapping[str, Any], tx_lines: list[dict[str, Any]] | None, receipt_id: str, status: int, amount_in: int, submit_to_receipt_ms: int, route_id: str, route_family: str, strategy_family: str, capture_lane_pending: str, realized_after_usd: float, borrow_cost_usd: float, net_realized_usd: float, gas_cost_wei: int, profitability_chain: Mapping[str, Any], borrowing: Mapping[str, Any], loan_result: Mapping[str, Any], outcome_truth_verified: bool, prime_transition: Mapping[str, Any] | None = None) -> dict[str, Any]:
