...
class RuntimeStateFacade:
    ...
    def fund_summary_state(self) -> Dict[str, Any]: return self._state_summary_payload("fund_summary", default={}, default_factory=lambda: {**fund_summary_unavailable_payload(None), "capitalTruth": unavailable_state("capital_truth_service_unavailable")})
