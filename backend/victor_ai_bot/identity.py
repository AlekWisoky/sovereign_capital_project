...
def identity_from(value: Any) -> TradeIdentity | None:
    ...
    identity = TradeIdentity(
        decision_id=_text(
            ...
            or lineage.get("decision_id") or lineage.get("decisionId")
        ),
        correlation_id=_text(
            source.get("correlation_id") or source.get("correlationId")
            or nested.get("correlation_id") or nested.get("correlationId")
            or lineage.get("correlation_id") or lineage.get("correlationId")
        ),
        execution_id=_text(
            source.get("execution_id") or source.get("executionId")
            or nested.get("execution_id") or nested.get("executionId")
            or lineage.get("execution_id") or lineage.get("executionId")
        ),
        settlement_id=_text(
            source.get("settlement_id") or source.get("settlementId")
            or nested.get("settlement_id") or nested.get("settlementId")
