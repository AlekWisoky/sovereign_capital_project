...
def sentry_settings() -> Dict[str, Any]:
    ...
    return {
        ...
        # Keep the trading hot path cheap. Increase deliberately in staging if
        # deeper performance sampling is needed.
...
def set_sentry_trade_context(
    *,
    ...
    This intentionally excludes wallet secrets, private keys, raw payloads and
    capital balances. IDs are used so an error/trace can be correlated with the
    canonical decision -> execution -> settled-outcome ledger lineage.
    """
