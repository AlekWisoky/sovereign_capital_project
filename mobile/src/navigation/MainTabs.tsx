    ...
    <CommandCenterProvider>
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          <Tab.Screen name="Opportunities" component={OpportunitiesStack} options={{ tabBarLabel: 'Opportunities', tabBarIcon: ({ color }) => <Glyph label="OP" color={color} /> }} />
          <Tab.Screen name="AI" component={AIStack} options={{ tabBarLabel: 'OMAR / AI', tabBarIcon: ({ color }) => <Glyph label="AI" color={color} /> }} />
          <Tab.Screen name="Risk" component={RiskStack} options={{ tabBarLabel: 'Risk', tabBarIcon: ({ color }) => <Glyph label="RK" color={color} /> }} />
          <Tab.Screen name="Activity" component={ActivityStack} options={{ tabBarLabel: 'Activity', tabBarIcon: ({ color }) => <Glyph label="TX" color={color} /> }} />
        </Tab.Navigator>
        <ControlCenterSheet />
      </View>
    </CommandCenterProvider>
